...
```
cd existing_repo
git remote add origin http://gitlab-gitlab-ce1/wodnrdl7013/my2dangrybird.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab-gitlab-ce1/wodnrdl7013/my2dangrybird/-/settings/integrations)
